...
RUN LEDGER_ENABLED=false go build -work -tags muslc,linux,rocksdb -mod=readonly -ldflags="-extldflags '-L/code/mimalloc/build -lmimalloc'" -o build/mantlemint ./sync.go
